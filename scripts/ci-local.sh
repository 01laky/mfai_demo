...
for s in many_faces_backend many_faces_portal many_faces_admin many_faces_mobile many_faces_ai many_faces_database many_faces_redis many_faces_logger; do
