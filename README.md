...
| Mobile app    | [`many_faces_mobile/`](./many_faces_mobile/README.md)                                                                                                                                                                                                                             | **many_faces_mobile** — Expo (React Native) client; colocated folders + `yarn validate`; `node scripts/verify-mobile-component-colocation.mjs` in parent CI; runs outside Docker Compose (`yarn start`). Overview: [`docs/readmes/mobile-overview.md`](./docs/readmes/mobile-overview.md).                                                                                                                                 |
