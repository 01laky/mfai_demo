...
| [api-request-validation.md](./guides/api-request-validation.md)           | **FluentValidation** — `ValidationProblemDetails`, OAuth2 exception, `IFileValidator`, parity script, tests (2026-05-16). |
...
| [mobile-expo-development.md](./guides/mobile-expo-development.md)                           | **many_faces_mobile** — Expo, env, parity, colocation verify, `yarn validate`.                                                      |
...
| [readmes/mobile-overview.md](./readmes/mobile-overview.md)             | Expo client — colocation, quality gates, parity links.       |
