...
| [`many_faces_mailer/README.md`](../many_faces_mailer/README.md) | Mailer worker (gRPC + SMTP + templates) — see **[mailer-local-dev.md](./guides/mailer-local-dev.md)** for Mailpit, `Mail:*`, and grpcurl smoke. |
