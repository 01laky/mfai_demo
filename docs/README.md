...
| [ai-assisted-content-approval.md](./guides/ai-assisted-content-approval.md)           | Planned FE user-created album/blog/reel approval flow, AI review queue, admin moderation, superadmin override, audit log.                         |
