...
- [x] **`settings.signOut`** in panel when authenticated (portal settings tab logout).
...
| `features/settings` shell + language + sign out | **Done** — §24.6 (language, logout, device locale)                                               |
