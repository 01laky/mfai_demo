# Husky & Pre-commit Hooks Setup (archived copy)

**Status:** Canonical, up-to-date rules and commands live in **[`../development.md`](../development.md)** (section **Git hooks (Husky + commitlint)**). This file preserves the older long-form narrative and diagram for reference.

**Note:** `many_faces_backend` also uses **Yarn 4 + Husky + commitlint** (see `development.md`); the summary table at the end of this legacy copy was outdated on that point.
...
| many_faces_backend  | Husky      | (via Yarn) | dotnet format / lint | commitlint |
| many_faces_database | -          | -       | -          | -          |
| many_faces_redis    | -          | -       | -          | -          |
| many_faces_logger   | -          | -       | -          | -          |
