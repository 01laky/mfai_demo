...
| Push / FCM (optional) | `many_faces_push/` | **Go gRPC** FCM worker + compose; local dev: [`push-notifications-local-dev.md`](./guides/push-notifications-local-dev.md), repo [`many_faces_push/README.md`](../../many_faces_push/README.md). |
